...
class CollegeServiceImplTest {
    ...
    void getCollegeByName() {
        when(repo.findAllByNameStartingWithIgnoreCase(anyString(),any(Pageable.class)))
                .thenReturn(new PageImpl<College>(List.of(collegeentity)));
    ...
    void getCollegeById() {
        ...
        given(repo.findById(anyInt())).willReturn(Optional.ofNullable(collegeentity));
    ...
    public void testDelete() {
        ...
        willDoNothing().given(repo).deleteById(anyInt());
